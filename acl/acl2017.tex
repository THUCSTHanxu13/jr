...
\begin{figure}[]
\centering
\includegraphics[width=0.98\columnwidth]{joint.jpg}
...
% Since there is much noise in plain text and distant supervision, it makes the task not easy. 
...
% The 
 ...
 % though these features are structured. The knowledge features are also structured and learned by the model automatically without supervision. Hence, proposing better models to mining inner features is more important than designing new features for solving RE.
